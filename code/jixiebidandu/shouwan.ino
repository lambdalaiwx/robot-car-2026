...
// --- 测试引脚设定 ---
const int TEST_PIN = 8; // 当前测试：D8 (夹爪后方第一关节)

// 初始安全角度 (建议用手把机械臂托平，然后上电，通常 90 度是居中位置)
int currentAngle = 90; 
